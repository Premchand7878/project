...
//                                 We provide professional graphic design services to help businesses build a strong, engaging online presence. Our designs are visually appealing, user-friendly, and tailored to your brand. Let us help you create impactful, memorable visuals.
//                                 </div>
//                             </div>
//                         </div>
//                         <div className="service">
...
//                                         <input type="text" ref={fullName} placeholder='prem' name="name" id="name" />
//                                     </div>
//                                     <div className="form-section">
//                                         <label htmlFor="email">Email</label>
//                                         <input type="text" ref={email} placeholder='prem@gmail.com' name="email" id="email" />
//                                     </div>
//                                     <div className="form-section">
